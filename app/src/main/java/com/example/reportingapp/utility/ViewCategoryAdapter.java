...
public class ViewCategoryAdapter extends ArrayAdapter<Report> {
    private final int mLayoutResource;
    private final Context mContext;
    public ViewCategoryAdapter(@NonNull Context context, int resource, @NonNull List<Report> objects) {
